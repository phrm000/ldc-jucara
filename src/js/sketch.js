...
function draw() {
  ...
  const productDescFieldText = productDescriptionField.value;
    ...
    //Create set of components each frame
    if (frameCount <= fruitsPerCurve) {
      ...
      if (fruitsPerCurve <= pointsForSpline.length) { //TODO  change this to also add every frame
...
//Draws text and container for title + description
